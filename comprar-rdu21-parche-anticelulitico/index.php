...
<head>
	<meta charset="UTF-8">
	<title>Comprar Parche Anticelulítico | Rdu21</title>
	<meta name="description" content="Compra el parche anticelulitico con estudios clínicos comprobados resultados visibles en 21 días sin pastillas ni cremas fáciles de usar y muy cómodos tonifica tus gluteos y piernas">
...
<body>
    ...
    <section class="producto-container" >
         <form action="https://www.pagoagil.net/onestep" method="post">
            <div class="contenedor-producto" >
                <header><h1>Parche Anticelulítico</h1></header>
                <figure class="producto-imagen">
                    <img src="../img/parche-anticelulitico-rdu21-2.png" alt="Parche Vientre Plano">
                </figure>
                <div class="carrito">
                    <div class="precio-unidad">
                        <p class="precio-uni" id="precio">$78.500</p>
                    ...
                    <div class="precio-total">
                        ...
                        <p  class="precio">$ <span id="precio3">78.500</span></p>
            ...
            <input type="hidden" name="referencia_producto" value="0301010201022">
            <input id="fdescripcion_producto" type="hidden" name="descripcion_producto" value="Rdu21 Parche Anticelulítico ">
            <input id="fmoneda" type="hidden" name="moneda" value="COP">
            <!---Campos importantes -->
            <input type="hidden" id="precio" value="78500">
    ...
    <section class="contenedor-caracteristicas">
        <ul class="tabs">
            ...
            <li id="faq"class="tab"><p>RECOMENDACIONES</p></li>
        </ul>
        <div class="content-tabs">
            <div id="detalles-tab" class="content-tab">
                <article>
                   <p>La tecnología de parche de acción anticelulítica profunda de Rdu21® Parche Anticelulítico, logra un efecto sostenido durante 24 horas y está especialmente indicada para reducir la celulitis,  gracias a la acción de sus ingredientes naturales que ayudan a combatir la grasa acumulada en las capas más profundas de la piel. Se recomienda una alimentación balanceada y la práctica de algún ejercicio para un mejor efecto del producto.</p>

                    <p>Rdu21® Parche Anticelulítico  cuenta con estudios clínicos europeos de eficacia cosmética en la reducción considerable de la celulitis, tejido adiposo o tejido graso local y los nódulos o protuberancias en los muslos y glúteos, mientras mejora la hidratación y elasticidad de la piel.</p>

                    <h3>ASÍ ACTÚAN LOS INGREDIENTES NATURALES</h3>

                    <p>Nuestra formula clínicamente comprobada contiene seis ingredientes naturales para reducir la celulitis:</p>
                    
                    <ul>
                    <li>Alga Fucus (Fucus vesiculosus):  Contrarresta la grasa corporal.</li>
                    <li>Caffeíne: Disminuye y evita los depósitos de grasas localizadas.</li>
                    <li>Carnitine (L-carnitina): Desintegra y quema las grasas.</li>
                    <li>Té Verde (camelia sinensis extract):  Reconocido liporeductor.</li>
                    <li>Hiedra y Castaño de Indias (Hedera hélix extract , aesculus hippocastanum extract): Estimulan la circulación.</li>
                    </ul>
                    <h3>TECNOLOGÍA DE ACCIÓN PROFUNDA EN LA PIEL</h3>

                    <p>Rdu21® Parche Anticelulítico cuenta con estudios clínicos de eficacia cosmética realizados en Europa en la reducción de la celulitis en muslos y/o glúteos. </p>
      ...
      <footer>
            <div class="contenedor-footer">
                <nav class="menu-foot">
                    ...
                    <li><a href="../index.php#estudios">Estudios clinicos</a></li>
...
$(document).ready(function(){
 ...
 $("#faq").removeClass("current-tab");
  ...
  var referencia = ""+agno+mes+dia+hora+minutos+milisegundos;
    ...
    $("#fmonto").val($("#selcantidad").val()*78500);
    $("#fvalor").val($("#selcantidad").val()*78500);
    $("#fiva").val($("#fvalor").val()*0.16);
    $("#fcantidad").val($("#selcantidad").val());
    $("#precio3").text($("#selcantidad").val()*78500);
